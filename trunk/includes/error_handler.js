...
'			<link href="' + BASE_FOLDER + 'includes/errorConsole.css" rel="stylesheet" type="text/css" />\n' +
'			<script type="text/javascript" src="' + BASE_FOLDER + 'includes/errorConsole.js"></scr' + 'ipt>\n' +
'			</head>\n' + 
'		<body>\n');
