<?php
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,doc,xls";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,doc,xls";
	$mcFileManagerConfig['upload.invalid_extension_msg'] = "Error: Invalid extension: Valid extensions are: gif,jpg,htm,pdf,doc,xls.";
