...
?>
					<div class="AdminTopicHeader">Apple Retail Stores</div>
					...
					<table id='List' class='List' style='width: 100%;' cellpadding="0" cellspacing="0">
						<tr>
							...
							<? sortList('Country', 'chrCountry'); ?>
							<? sortList('Region', 'chrRegion'); ?>
...
?>
						...
						onmouseover='RowHighlight("tr<?=$row['ID']?>");' onmouseout='UnRowHighlight("tr<?=$row['ID']?>");'>
							...
							<a href="javascript:warning(<?=$row['ID']?>,'<?=encode($row['chrName'])?>');"><img id='deleteButton<?=$row['ID']?>' src='<?=$BF?>images/button_delete.png' alt='delete button' /></a>
							</div></td>			
						</tr>
<?
	}
