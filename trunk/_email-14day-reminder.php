...
<? 
	...
	while($info = mysqli_fetch_assoc($result)) {
	    $to      = $info['chrEmail'];
		$Message = $info['chrName']. ",\n\nThis is a notice to remind you it is the 14th of ". date("F Y",strtotime("today")) ." and your store has not yet finalized and submitted a Calendar of Events for ". date("F",strtotime("+1 Month")) ." ". $year .".";
	...
	if($msg != '') { 
		$msg2 = "The follow stores did not submit a calendar as of the 14th of ". 	date("F",strtotime("today")) . " for the ". date("F Y",strtotime("+1 Month")) ." COE\n\n" . $msg;
		mail('t.nguyen@apple.com,manderson@apple.com,drone@techitsolutions.com', 'Day 14 COE Reminder List', $msg2, $headers);
